...
if __name__ == "__main__":
    ...
    ld_5513 = LinkerScript()
    if not ld_5513.get_config_args():
        sys.exit(0)
    chip_version = ld_5513.get_chip_version()
    ...
    if not ld_5515.get_config_args():
        sys.exit(0)
    chip_version = ld_5515.get_chip_version()
    file_5515 = "gr5515.lds"
    if ld_5515.make(ld_5515.get_lds_path(lds_path, file_5515)):
        print(">>> Generate gr5515 lds file finish ...")
        sys.exit(0)
