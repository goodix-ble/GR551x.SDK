...
#  Command :
#        pyhon keil2iarprj.py  *.uvprojx  gr5513/gr5515
...
G_IAR_ICF_13        = "gr5513_template.icf"
G_IAR_ICF_15        = "gr5515_template.icf"
...
G_LDS_FILE_13       = G_ICF_PATH + G_IAR_ICF_13
G_LDS_FILE_15       = G_ICF_PATH + G_IAR_ICF_15
class IARICFConfig():
    ...
    def make(self, file_path):
        ...
        if file_path.__contains__("gr5513"):
            path = PROJECT_PATH +  "gr5513.icf"
        else:
            path = PROJECT_PATH +  "gr5515.icf"
