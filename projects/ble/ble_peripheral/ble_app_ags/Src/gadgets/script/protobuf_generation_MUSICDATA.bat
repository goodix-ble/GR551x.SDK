...
@set SPEECHDATA_PROTO_FILE_PATH="..\Src\gadgets\Alexa-Gadgets-Embedded\AlexaGadgetsProtobuf\Alexa.Gadget.SpeechData\Speechmarks"
@set MUSICDATA_PROTO_FILE_PATH="..\Src\gadgets\Alexa-Gadgets-Embedded\AlexaGadgetsProtobuf\Alexa.Gadget.MusicData\Tempo"

::set protoc generation directory
@set PROTOC_GENERATION_DIR="..\Src\gadgets\generated\alexa\protobuf"

::start compilation
%PROTOC_BIN_PATH%\protoc.exe -I. -I. -I%BASE_PROTO_FILE_PATH_1% -I. -I%BASE_PROTO_FILE_PATH_2% -I. -I%BASE_PROTO_FILE_PATH_3% -I. -I%BASE_PROTO_FILE_PATH_4% -I. -I%BASE_PROTO_FILE_PATH_5% -I. -I%NOTI_PROTO_FILE_PATH_1% -I. -I%NOTI_PROTO_FILE_PATH_2% -I. -I%ALERT_PROTO_FILE_PATH_1% -I. -I%ALERT_PROTO_FILE_PATH_2% -I. -I%STATELISTENER_PROTO_FILE_PATH% -I. -I%SPEECHDATA_PROTO_FILE_PATH% -I. -I%MUSICDATA_PROTO_FILE_PATH% --nanopb_out=%PROTOC_GENERATION_DIR% alexaGadgetMusicDataTempoDirective.proto || exit /b
%PROTOC_BIN_PATH%\protoc.exe -I. -I. -I%BASE_PROTO_FILE_PATH_1% -I. -I%BASE_PROTO_FILE_PATH_2% -I. -I%BASE_PROTO_FILE_PATH_3% -I. -I%BASE_PROTO_FILE_PATH_4% -I. -I%BASE_PROTO_FILE_PATH_5% -I. -I%NOTI_PROTO_FILE_PATH_1% -I. -I%NOTI_PROTO_FILE_PATH_2% -I. -I%ALERT_PROTO_FILE_PATH_1% -I. -I%ALERT_PROTO_FILE_PATH_2% -I. -I%STATELISTENER_PROTO_FILE_PATH% -I. -I%SPEECHDATA_PROTO_FILE_PATH% -I. -I%MUSICDATA_PROTO_FILE_PATH% --nanopb_out=%PROTOC_GENERATION_DIR% alexaGadgetMusicDataTempoDirectivePayload.proto || exit /b
