...
::start compilation
%PROTOC_BIN_PATH%\protoc.exe -I. -I. -I%BASE_PROTO_FILE_PATH_1% -I. -I%BASE_PROTO_FILE_PATH_2% -I. -I%BASE_PROTO_FILE_PATH_3% -I. -I%BASE_PROTO_FILE_PATH_4% -I. -I%BASE_PROTO_FILE_PATH_5% -I. -I%NOTI_PROTO_FILE_PATH_1% -I. -I%NOTI_PROTO_FILE_PATH_2% --nanopb_out=%PROTOC_GENERATION_DIR% notificationsSetIndicatorDirective.proto || exit /b
%PROTOC_BIN_PATH%\protoc.exe -I. -I. -I%BASE_PROTO_FILE_PATH_1% -I. -I%BASE_PROTO_FILE_PATH_2% -I. -I%BASE_PROTO_FILE_PATH_3% -I. -I%BASE_PROTO_FILE_PATH_4% -I. -I%BASE_PROTO_FILE_PATH_5% -I. -I%NOTI_PROTO_FILE_PATH_1% -I. -I%NOTI_PROTO_FILE_PATH_2% --nanopb_out=%PROTOC_GENERATION_DIR% notificationsSetIndicatorDirectivePayload.proto || exit /b
%PROTOC_BIN_PATH%\protoc.exe -I. -I. -I%BASE_PROTO_FILE_PATH_1% -I. -I%BASE_PROTO_FILE_PATH_2% -I. -I%BASE_PROTO_FILE_PATH_3% -I. -I%BASE_PROTO_FILE_PATH_4% -I. -I%BASE_PROTO_FILE_PATH_5% -I. -I%NOTI_PROTO_FILE_PATH_1% -I. -I%NOTI_PROTO_FILE_PATH_2% --nanopb_out=%PROTOC_GENERATION_DIR% notificationsClearIndicatorDirective.proto || exit /b
%PROTOC_BIN_PATH%\protoc.exe -I. -I. -I%BASE_PROTO_FILE_PATH_1% -I. -I%BASE_PROTO_FILE_PATH_2% -I. -I%BASE_PROTO_FILE_PATH_3% -I. -I%BASE_PROTO_FILE_PATH_4% -I. -I%BASE_PROTO_FILE_PATH_5% -I. -I%NOTI_PROTO_FILE_PATH_1% -I. -I%NOTI_PROTO_FILE_PATH_2% --nanopb_out=%PROTOC_GENERATION_DIR% notificationsClearIndicatorDirectivePayload.proto || exit /b